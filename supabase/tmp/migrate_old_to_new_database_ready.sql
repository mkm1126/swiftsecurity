...
-- 2. Run this in NEW database: https://supabase.com/dashboard/project/aciuwjjucrfzhdhqmixk/sql
-- ============================================================================
...
SELECT request_id, role_code, details, created_at FROM (
  ...
  FROM dblink('dbname=postgres host=db.lyzcqbbfmgtxieytskrf.supabase.co port=5432 user=postgres password=Mucfrev@9xe',
