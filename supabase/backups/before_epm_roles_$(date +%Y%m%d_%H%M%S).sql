/*
  ...
  To restore this state, the following EPM roles should be removed from role_catalog:
  - data_extracts
  - basic_report_dev
  - advanced_report_dev
  - dashboard_developer
  ...
  Note: This backup was created before implementing EPM role code templates.
  The current role_catalog likely does not contain these entries yet.
*/
