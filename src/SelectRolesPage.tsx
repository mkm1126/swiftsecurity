    ...
    try {
      if (isEditingCopiedRoles) {
        ...
        const requiredFields = {
          ...
          is_non_employee: d.isNonEmployee || false,
          work_location: d.workLocation || null,
          work_phone: d.workPhone || null,
          email: d.email,
          ...
          supervisor_username: d.supervisorUsername,
          security_admin_name: d.securityAdminName,
          security_admin_username: d.securityAdminUsername,
          poc_user_name: pocUser || null,
          status: 'pending',
        };
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-8">
                ...
                <table className="min-w-full border border-gray-300 border-collapse">
                  ...
                  <tbody className="bg-white divide-y divide-gray-300">
                    ...
                    <tr>
                      <td colSpan={2} className="px-6 py-4">
                        <div className="space-y-4">
                          <h4 className="text-sm font-medium text-gray-700">Authorize templates</h4>
                          <div className="overflow-x-auto">
                            <table className="min-w-full border border-gray-300">
                              <thead>
                                <tr className="bg-gray-50">
                                  <th className="px-3 py-2 text-left text-xs font-medium text-gray-700 border-r border-gray-300">Template Type</th>
                                  {ssActions.map((action) => (
                                    <th key={action} className="px-3 py-2 text-center text-xs font-medium text-gray-700 border-r border-gray-300 last:border-r-0">
                                      {action}
                                    </th>
                                  ))}
                                </tr>
                              ...
                              <tbody>
                                {ssTemplateRows.map((template, rowIndex) => (
                                  <tr key={template} className="border-t border-gray-300">
                                    <td className="px-3 py-2 text-sm text-gray-700 border-r border-gray-300">{template}</td>
                                    {ssActions.map((action) => {
                                      const fieldName = `ssTemplate${template.replace(/\s+/g, '')}${action}` as keyof SecurityRoleSelection;
                                      return (
                                        <td key={action} className="px-3 py-2 text-center border-r border-gray-300 last:border-r-0">
                                          <input
                                            type="checkbox"
                                            {...register(fieldName)}
                                            className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          <label className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Tech Coord Approver</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Tech State Approver</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Grant Coord Approver</span>
                          </label>
                        </div>
                      </td>
                    </tr>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                          <label className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Catalog Owner</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Catalog Inquiry Only</span>
                          </label>
                        </div>
                      </td>
                    </tr>
                        ...
                        <div className="space-y-4">
                          <label className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Agreement Manager</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                        ...
                        <div className="space-y-4">
                          <label className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Contractual Approver</span>
                          </label>
                          
                          <div className="flex items-center space-x-6">
                            <span className="text-sm text-gray-700">Electronic docs?</span>
                            <label className="flex items-center">
                              <input
                                type="checkbox"
                          ...
                          <label className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">DOC Contract Coordinator</span>
                          </label>
                        </div>
                      </td>
                    </tr>
              ...
              <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg mb-6">
                <table className="min-w-full divide-y divide-gray-300">
                  <thead className="bg-green-600">
                    <tr>
                      <th colSpan={3} className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">
                        ...
                        <div className="space-y-3">
                          <label className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Express Issue</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Adjustment Approver</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Replenishment Buyer</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Control Worker</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Express Putaway</span>
                          </label>
                        </div>
                      </td>
                      <td className="px-6 py-4 border-r border-gray-300">
                        <div className="space-y-3">
                          <label className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Fulfillment Specialist</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">PO Receiver</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Returns Receiver</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Cost Adjustment</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Materials Manager</span>
                          </label>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="space-y-3">
                          ...
                          <label className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Inquiry Only</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Configuration Agency</span>
                          </label>
                          <label className="flex items-center">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span className="text-sm text-gray-700">Pick Plan Distribution Release</span>
                          </label>
                        </div>
                      </td>
                    </tr>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <textarea
                      ...
                      rows={4}
                      {...register('roleJustification' as any)}
                      className="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
                      placeholder="Please provide justification for the selected roles..."
                    />
                  </div>
                  <p className="mt-2 text-sm text-gray-500">
                    Explain why these specific roles are needed for the user's job responsibilities.
                  </p>
                </div>
              </div>
